 ...
 * @author Ján Švec
 */
public class AllResultsToTxtCleaned {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String p : directories) {
            ...
            if (new File(p + "results_cleaned/").exists()) {
                File folder = new File(p + "results_cleaned/");
                ...
                PrintWriter out;
                out = new PrintWriter("output/spolu" + poc + "_cleaned.txt");
