...
<div class="containerHalfGreen"> 
    ...
    <br/>
    <fmt:message key="preview.download2" /> <a href="getfile?name=download/author_corpus_v1.zip">version_1.zip</a>,  
    <a href="getfile?name=download/author_corpus_v2.zip">version_2.zip</a> 
    <br/> 
